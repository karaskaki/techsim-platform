...
async function seedLLDProblems() {
    try {
        ...
        for (const prob of exports.INITIAL_LLD_PROBLEMS) {
            await lldSubmission_1.LLDProblem.findOneAndUpdate({ slug: prob.slug }, prob, { upsert: true, new: true });
        }
        console.log(`✅ Successfully seeded ${exports.INITIAL_LLD_PROBLEMS.length} LLD problems!`);
